...
public class PropertiesForIndexingDao extends AbstractDao {
	...
	// these fields
	private static String DOCUMENT_FIELDS_SELECT = "select pl.PROPERTY_REF, SOURCE, TITLE, PROPERTY_DETAILS_URL, pl.CRAWL_TIME, "
	...
	private static String LIMIT = " limit 500";
...
/*	public static enum Fields {
	...
	public Set<SolrInputDocument> getSolrDocumentsToAdd() {
		...
		Set<SolrInputDocument> addedDocs = new HashSet<SolrInputDocument>();
		try {
