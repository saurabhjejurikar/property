...
//		if(propertyListContext.getfLowerPrice() > 0 && propertyListContext.getfUpperPrice() >0) {
//			params.add("fq", Property.Fields.MONTHLY_RENTAL.toString() + ":[" + lowerPrice + " TO " + upperPrice + "]");
//		} else if(lowerPrice > 0) {
//			params.add("fq", Property.Fields.MONTHLY_RENTAL.toString() + ":[" + lowerPrice + " TO *]");
//		} else if(upperPrice < upperLimit) {
//			params.add("fq", Property.Fields.MONTHLY_RENTAL.toString() + ":[* TO " + upperPrice + "]");
//		} else {
//			params.add("fq", Property.Fields.MONTHLY_RENTAL.toString() + ":[1 TO *]");
//		}
